    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 to-pink-500 flex-col justify-between p-12 text-white">
        ...
        <div className="max-w-md">
          <h1 className="text-4xl font-bold mb-6">Welcome Back to Blissora</h1>
          <p className="text-purple-100 text-lg">
            Discover curated collections, exclusive deals, and a seamless shopping experience tailored just for you.
          </p>
        </div>
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-gray-600">Sign in to your Blissora account</p>
            </div>
