...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 to-pink-500 flex-col justify-between p-12 text-white">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
            <span className="text-purple-600 font-bold text-xl">B</span>
          </div>
          <span className="text-2xl font-bold">Blissora</span>
        </div>
        
        <div className="max-w-md">
          <h1 className="text-4xl font-bold mb-6">Join Blissora Today</h1>
        ...
        <div className="grid grid-cols-3 gap-4 max-w-md">
          {[1, 2, 3, 4, 5, 6].map((item) => (
            <div key={item} className="bg-white bg-opacity-20 rounded-lg p-2 backdrop-blur-sm">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="lg:hidden flex justify-center mb-8">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-3xl font-bold text-gray-900">Blissora</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-gray-600">Join Blissora and start your shopping journey</p>
            </div>
                  ...
                  <div className="mt-2">
                    <div className="flex justify-between text-xs text-gray-600 mb-1">
                      ...
                      <span className={`font-medium ${
                        ...
                        passwordStrength.text === 'Good' ? 'text-blue-600' : 'text-green-600'
                      }`}>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div 
                        className={`h-2 rounded-full transition-all duration-300 ${
                          ...
                          passwordStrength.text === 'Fair' ? 'bg-yellow-500 w-1/2' :
                          passwordStrength.text === 'Good' ? 'bg-blue-500 w-3/4' : 'bg-green-500 w-full'
                        }`}
                      ></div>
                    </div>
                  </div>
            ...
            <div className="mt-8">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-200 transform hover:scale-[1.02]"
                >
